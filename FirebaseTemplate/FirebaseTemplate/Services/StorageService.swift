        ...
        storageProfileImageRef.putData(imageData, metadata: metaData) {
            ...
            storageProfileImageRef.downloadURL{
                ...
                if let metaImageUrl = url?.absoluteString {
                    ...
                    let user = User.init(Name: username, email: email, uid: userId, profileImageUrl: metaImageUrl)
            ...
            storagePostRef.putData(imageData, metadata: metadata) {
                ...
                storagePostRef.downloadURL{
                    ...
                    if let metaImageUrl = url?.absoluteString {
                        ...
                        let post = PostModel.init(caption: caption, geoLocation: "", ownerId: userId, UserName: Auth.auth().currentUser!.displayName!, profile: Auth.auth().currentUser!.photoURL!.absoluteString, mediaUrl: metaImageUrl, date: Date().timeIntervalSince1970, postId: postId)
