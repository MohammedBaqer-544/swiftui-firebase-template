...
struct Post: View {
    ...
    @State private var alertTitle: String = "أوه لااا"
    ...
    func errorCheck() -> String? {
        if text.trimmingCharacters(in: .whitespaces).isEmpty || imageData.isEmpty {
            ...
            return "يرجى إضافة نص توضيحي وإضافة صورة"
        }
        return nil
    }
    ...
    var body: some View {
        ...
        VStack {
            ...
            Button(action: uploadPost) {
                ...
                Alert(title: Text(alertTitle), message: Text(error), dismissButton: .default(Text("حسناً")))
            }
...
//            ImagePicker(pickedImage: self.$pickedImage, showImagePicker: self.$showingImagePicker, imageData: self.$imageData)
            ...
            ActionSheet(title: Text(""), buttons: [
                            .default(Text("اختر صورة من المكتبة") ){
                                self.sourceType = .photoLibrary
                                self.showingImagePicker = true
                                
                            },
                .default(Text("التقط صورة") ){
